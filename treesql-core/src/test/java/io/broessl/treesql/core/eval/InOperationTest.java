...
public class InOperationTest {
  ...
  void testInListTrue() {
    ...
    TreeValue b = new TreeList(List.of(new TreeNumber(1), new TreeNumber(5), new TreeNumber(10)));
  ...
  void testInListFalse() {
    ...
    TreeValue b = new TreeList(List.of(new TreeString("bar"), new TreeString("baz")));
    TreeValue result = op.call(new TreeValue[] {a, b});
    assertTrue(result instanceof TreeBool);

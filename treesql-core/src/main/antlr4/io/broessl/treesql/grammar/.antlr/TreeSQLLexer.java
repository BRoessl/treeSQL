...
public class TreeSQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "OPEN_PAR", "CLOSE_PAR", "COMMA", "STAR", "PLUS", "MINUS", 
			...
			"ESC_JSON", "UNICODE", "HEX", "SAFECODEPOINT_JSON", "DIGIT"
		};
	}
	...
	public TreeSQLLexer(CharStream input) {
		super(input);

...
public abstract sealed class TreePrimitive extends TreeValue implements Comparable<TreePrimitive>
  ...
  public static TreePrimitive createTreePrimitive(Object o) {

    if (o instanceof TreePrimitive prim) {
      return prim;
    }
    ...
    if (o instanceof List<?> list) {
      List<TreePrimitive> treePrimitives = new ArrayList<>();
  ...
  public static <T extends TreePrimitive> T convert(Object o, Class<T> targetType) {
    ...
    o = o instanceof TreePrimitive prim ? prim.getValue() : o;
    ...
    if (targetType == TreeList.class) {
      ...
      List<TreePrimitive> singleItemList = new ArrayList<>();

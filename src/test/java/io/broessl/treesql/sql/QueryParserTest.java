...
public class QueryParserTest {
        ...
        void testSimpleQueryExecutionNew() throws Exception {
                ...
                parsedQuery.execute(NavigableJsonNode.linkRoot(TestWithJsonData.testDataSimpleDataTree())).sequential()
                                .forEach(row -> {
        ...
        void testDoubledFromQueryExecution() throws Exception {
                ...
                List<List<TreePrimitive>> result = parsedQuery
                                .execute(NavigableJsonNode.linkRoot(TestWithJsonData.testDataPattern())).sequential()
                                .toList();

...
public class OrOperation extends StackOperation {
    @Override
    ...
    public TreePrimitive call(TreePrimitive[] arguments) {
        if (arguments == null || arguments.length != 2) {
            throw new IllegalArgumentException("OrOperation requires exactly 2 arguments");
        }
        ...
        if (a instanceof TreeBool boolA && b instanceof TreeBool boolB) {
            ...
            throw new IllegalArgumentException("OrOperation only supports booleans");
        }
    }
}
